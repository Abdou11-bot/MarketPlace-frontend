...
@Component({
  selector: 'app-medecin-header',
  templateUrl: './medecin-header.component.html',
  styleUrls: ['./medecin-header.component.css']

})
export class MedecinHeaderComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    let MedecinSpaceResponse = this.StorageService.getUserFromStorage();
    if(MedecinSpaceResponse.trim() != 'medecin'){
